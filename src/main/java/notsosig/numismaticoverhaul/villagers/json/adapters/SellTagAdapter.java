...
public class SellTagAdapter extends TradeJsonAdapter {
    ...
    public VillagerTrades.ItemListing deserialize(JsonObject json) {
        ...
        final String tagStr = GsonHelper.getAsString(sellObject, "tag");
        final ResourceLocation tag = ResourceLocation.tryParse(tagStr);
        if (tag == null) throw new DeserializationException("Invalid tag resource location: " + tagStr);
    ...
    private static class Factory implements VillagerTrades.ItemListing, NumOTrade {
        ...
        public MerchantOffer getOffer(Entity entity, RandomSource random) {
            ...
            return new MerchantOffer(CurrencyHelper.getClosestItemCost(price), sellStack, this.maxUses, this.experience, multiplier);
        }
    }
