...
public class ProcessItemAdapter extends TradeJsonAdapter {
    ...
    private static class Factory implements VillagerTrades.ItemListing, NumOTrade {
        ...
        public MerchantOffer getOffer(Entity entity, RandomSource random) {
            return new MerchantOffer(CurrencyHelper.getClosestItemCost(price), Optional.of(new ItemCost(buy.getItem(), buy.getCount())), sell, this.maxUses, this.experience, this.multiplier);
        }
    }
}
